          ...
          if (snapshot.hasData) {
            return WillPopScope(
              ...
              child: Scaffold(
                body: Stack(
                  children: <Widget>[
                    confirmedImageBlock(snapshot.data.identifiedList[0].image),
                    BackButton(),
...
Widget confirmedImageBlock(String imageLink) {
  return Container(
          ...
          return Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    Expanded(
                        flex: 4,
                        child: textDisplay(
                            finalObject.identifiedList[0].species +
                                " " +
                                finalObject.identifiedList[0].animalName)),
                    SizedBox(
                      height: 1.0,
                    ),
                    Expanded(
                        flex: 1,
                        child: blocks(
                            finalObject.identifiedList[0].accuracyScore)),
                  ],
                ),
                Divider(),
                Column(
                  children: <Widget>[
                    identifyText,
                    SpoorIdentification(
                        animalIdentified: finalObject.identifiedList[0]),
                  ],
                ),
                Divider(),
                Column(
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Expanded(
                          flex: 1,
                          child: similarSpoor(finalObject.identifiedList),
                        )
                      ],
                    )
                  ],
                ...
                Divider(),
                Column(
                  children: <Widget>[tagText, Tags(tags: finalObject.tags)],
                ),
                Divider(),
                Row(
                  children: <Widget>[
...
class SpoorIdentification extends ViewModelWidget<ConfirmedViewModel> {
  ...
  SpoorIdentification({Key key, this.animalIdentified})
        ...
        children: <Widget>[
          ...
          Expanded(
              ...
              child: confidentImageDetails(
                  animalIdentified.type,
                  animalIdentified.animalName,
                  animalIdentified.species,
                  animalIdentified.accuracyScore))
        ],
      ),
    );
  }
...
class PossibleTags extends ViewModelWidget<ConfirmedViewModel> {
  ...
  String species;
  int score;
  PossibleTags({Key key, this.image, this.name, this.score, this.species})
      : super(key: key);
        ...
        children: <Widget>[
          ...
          Expanded(
              child: Container(
                  alignment: Alignment.centerLeft,
                  margin: new EdgeInsets.only(left: 8),
                  child: text4(species, 15)),
              flex: 1),
          Expanded(
              child: Container(
                  alignment: Alignment.centerLeft,
                  margin: new EdgeInsets.only(left: 8),
                  child: text4("$score%", 15)),
              flex: 1),
        ],
      ),
    );
...
Widget confidentImageDetails(
    String type, String name, String species, int score) {
  return Container(
    alignment: Alignment.center,
    ...
    child: Column(children: <Widget>[
      Expanded(
          ...
          child: Row(children: <Widget>[
            Expanded(flex: 1, child: text3("Type:", 16)),
            Expanded(flex: 1, child: text4(type, 16))
          ])),
      Expanded(
          flex: 1,
          child: Row(children: <Widget>[
            Expanded(flex: 1, child: text3("Animal:", 16)),
            Expanded(flex: 1, child: text4(name, 16))
          ])),
      Expanded(
          flex: 1,
          child: Row(children: <Widget>[
            Expanded(flex: 1, child: text3("Species", 16)),
            Expanded(flex: 1, child: text4(species, 15))
          ])),
      Expanded(
          flex: 1,
          child: Container(
              alignment: Alignment.centerLeft,
              child: text3("Accuracy Score:", 17))),
      Expanded(
          flex: 2,
          child: Container(
              alignment: Alignment.centerLeft, child: text3("$score%", 47))),
    ]),
  );
}
  ...
  return Container(
    ...
    child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return PossibleTags(
            image: possibleAnimals[index].image,
            name: possibleAnimals[index].animalName,
            species: possibleAnimals[index].species,
            score: possibleAnimals[index].accuracyScore,
          );
        }),
  );
}
      ...
      child: Column(
        ...
        children: <Widget>[
          Expanded(
              flex: 1,
              child: Container(
                  alignment: Alignment.centerLeft, child: text(name, 20))),
          Expanded(
              flex: 1,
              child: Container(
                  alignment: Alignment.centerLeft,
                  child: text2("Swipe up for more options", 13)))
        ],
      ));
}
