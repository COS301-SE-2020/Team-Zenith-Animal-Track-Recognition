      ...
      children: <Widget>[
        Expanded(
            ...
            child: Container(
                ...
                child: text("Spoor could not be identified", 20))),
        Expanded(
            flex: 1,
            child: Container(
                alignment: Alignment.centerLeft,
...
class NotConfirmedScroll extends ViewModelWidget<NotConfirmedViewModel> {
  const NotConfirmedScroll({Key key}) : super(key: key, reactive: true);
