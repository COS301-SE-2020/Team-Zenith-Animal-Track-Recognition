...
class ProfileListBody extends ViewModelWidget<ProfileViewModel> {
  List<ProfileModel> animalList;
  ProfileListBody({Key key, this.animalList}) : super(reactive: true);
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: Container(
                              alignment: Alignment.center,
                              margin: new EdgeInsets.only(right: 10, bottom: 6),
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                    ...
                    child: Container(
                      color: Colors.white,
                      child: text2("Species: ", 12),
                    )),
                Expanded(
                    flex: 2,
                    child: Container(
                      color: Colors.white,
                      child: text3(species, 12),
                    )),
              ],
            )),
        Expanded(
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                    ...
                    child: Container(
                      color: Colors.white,
                      child: text2("Location: ", 12),
                    )),
                Expanded(
                    flex: 2,
                    child: Container(
                      color: Colors.white,
                      child: text3(location, 12),
                    )),
              ],
            )),
        Expanded(
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                    ...
                    child: Container(
                      color: Colors.white,
                      child: text2("Captured by: ", 12),
                    )),
                Expanded(
                    flex: 2,
                    child: Container(
                      color: Colors.white,
                      child: text3(capturedBy, 12),
                    )),
              ],
            )),
      ],
...
Widget textRow(String accuracy) {
  return Row(
    children: <Widget>[
      Expanded(
        flex: 2,
        child: text3("ACCURACY SCORE", 14),
      ),
      Expanded(
        flex: 1,
        child: text6(accuracy, 14),
      ),
    ],
  );
}
          ...
          children: <Widget>[
            Container(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: <Widget>[
                  Expanded(flex: 1, child: profilepic),
                  Expanded(flex: 3, child: profiletext)
                ],
              ),
            ),
            Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Expanded(
                ...
                child: Container(
                    alignment: Alignment.centerLeft,
                    child: text5('k.ndlovu@email.com', 15))),
          ],
        )),
    Expanded(
        flex: 1,
            ...
            children: <Widget>[
              Expanded(
                  ...
                  child: Container(
                    ...
                    height: 30,
                    width: 30,
                    child: Center(child: text2("$spoorIdentified", 20)),
                  )),
              Expanded(
                  flex: 1,
                  child: Container(
                    ...
                    child: Column(children: [
                      Expanded(
                          ...
                          child: Container(
                              ...
                              child: text3("Spoors", 10))),
                      Expanded(
                          flex: 1,
                          child: Container(
                              alignment: Alignment.topLeft,
                              child: text3("Identified", 10)))
                    ]),
                  )),
            ],
          ),
            ...
            children: <Widget>[
              Expanded(
                  ...
                  child: Container(
                      ...
                      height: 30,
                      width: 30,
                      child: Center(child: text2("$animalsTracked", 20)))),
              Expanded(
                  flex: 1,
                  child: Container(
                    margin: new EdgeInsets.all(0),
                    ...
                    child: Column(children: [
                      Expanded(
                          ...
                          child: Container(
                              alignment: Alignment.bottomLeft,
                              child: text3("Animals", 10))),
                      Expanded(
                          flex: 1,
                          child: Container(
                              alignment: Alignment.topLeft,
                              child: text3("Tracked", 10)))
                    ]),
                  )),
            ],
          ),
            ...
            children: <Widget>[
              Expanded(
                  ...
                  child: Container(
                      ...
                      height: 30,
                      width: 30,
                      child: Center(child: text2("$speciesTracked", 20)))),
              Expanded(
                  flex: 1,
                  child: Container(
                    margin: new EdgeInsets.all(0),
