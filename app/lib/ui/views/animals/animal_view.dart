                    ...
                    body: Container(
                      ...
                      child: TabBarView(
                        children: getBodyWidgets(
                            snapshot.data.length, snapshot.data.animalList),
                      ),
                    ),
        ...
        return Container(
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                ListTileTheme(
                    dense: true,
                    child: description(animalTabList[index].description)),
                ListTileTheme(
                    dense: true,
                    child: behaviour(animalTabList[index].behaviour)),
                ListTileTheme(
                    dense: true,
                    child: habitats(animalTabList[index].habitats)),
...
//=============================ANIMAL DETAILS===================
Widget cardText(String name, double sizeM, double sizeF, int weightM,
    int weightF, String diet, String gestation) {
  return Container(
      margin: EdgeInsets.all(0),
      alignment: Alignment.center,
      height: 75,
      ...
      child: Column(children: <Widget>[
        ...
        Expanded(
            ...
            child: Container(
                margin: EdgeInsets.all(0),
                padding: EdgeInsets.all(0),
                child: middleRow(sizeM, sizeF, weightM, weightF))),
        Expanded(
            flex: 1,
            child: Container(
                margin: EdgeInsets.all(0),
                padding: EdgeInsets.all(0),
                child: bottomRow(diet, gestation))),
      ]));
}
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              Expanded(
                flex: 1,
                child: text4("Gestation:", 12),
              ),
              Expanded(
                flex: 1,
                child: text3(gestation, 12),
              ),
            ],
          ),
        ),
