      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListTileTheme(dense:true,child: ViewButton()),
          ]
        ),
      );
    }
...
//=============================ANIMAL DETAILS===================
Widget cardText(String name, double sizeM, double sizeF, double weightM, double weightF,String diet, String gestation ){
  return Container(
    margin: EdgeInsets.all(0),
    alignment: Alignment.center,
    height: 75,
    ...
    child: Column(
      children:<Widget>[
        Expanded(flex:1,child: Container(margin: EdgeInsets.all(0),padding: EdgeInsets.all(0),child: text4(name,15))),
...
Widget middleRow(double sizeM, double sizeF, double weightM, double weightF){
  return Row(
    crossAxisAlignment: CrossAxisAlignment.center,
    mainAxisAlignment: MainAxisAlignment.center,
    children: <Widget>[
...
Widget column(double metricF, double metricM){
  return Column(
    children: <Widget>[
      Expanded(
        flex: 1,
          child: Row(children: <Widget>[
            Expanded(flex:2,child: Container(child: text3('$metricF', 10),)),
      ...
      Expanded(
        flex: 1,
          child: Row(children: <Widget>[
            Expanded(flex:2,child: Container(child: text3('$metricM', 10),)),
    ...
    children: <Widget>[
      Expanded(flex: 1,
        child: Container(
          margin: EdgeInsets.only(right:10),
          child: Row(children: <Widget>[
            Expanded(flex: 1,child: text4("Diet:",10),),
            Expanded(flex: 1,child: text3(diet, 10),),
          ],),
        ),
      ),
      Expanded(
        ...
        child: Container(
          margin: EdgeInsets.only(right:10),
          child: Row(children: <Widget>[
            Expanded(flex: 1,child: text4("Gestation:",10),),
            Expanded(flex: 1,child: text3(gestation, 10),),
          ],),
        ),
      ),
    ],
...
//=============================ANIMAL DETAILS BODY===================
Widget animalMetrics(double male,double female){
  return Container(
    ...
    child: Column(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        Expanded(flex: 1, child:Row(children: <Widget>[text3("$female m", 10), Icon(Icons.person, size: 5,)])),
        Expanded(flex: 1, child:Row(children: <Widget>[text3("$female m", 10), Icon(Icons.person, size: 5,)])),
    ],),
  );
}
