        ...
        return Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 35),
              ListTileTheme(dense: true,child: ViewButton(name: infomodel.commonName,),),
              SizedBox(height: 35),
              Tabz(infoModel: infomodel,),
            ],
          ),
        );
      }
...
Widget name(String name, String species){
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Expanded(flex: 1,child: text22CenterBoldBlack('$species')),Expanded(flex: 1,child: text20CenterNormBlack('$name'))
      ],
    ),
  );
}
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(flex: 3,child: Container(child: text12LeftNormGrey(female))),
            ],
          ),
          Row(
            children: <Widget>[
              Expanded(flex: 1, child: Container(child: Icon(Icons.person_pin,color: Colors.blue[200],size: 13,),)),
              Expanded(flex: 3,child: Container(child: text12LeftNormGrey(male))),
            ],
          )
        ],
      ),
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(children: <Widget>[Expanded(flex: 2,child: Container(child: text12LeftNormGrey(period))),],),
          Row(children: <Widget>[Expanded(flex: 1,child: Container()),Expanded(flex: 2,child: Container(child: Text(""),)),],)
        ],
      ),
    ),
  );
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(children: <Widget>[Expanded(flex: 1,child: Container(child: text12LeftNormGrey(diet))),],),
          Row(children: <Widget>[Expanded(flex: 1,child: Container()),Expanded(flex: 2,child: Container(child: Text(""),)),],)
        ],
      ),
    ),
